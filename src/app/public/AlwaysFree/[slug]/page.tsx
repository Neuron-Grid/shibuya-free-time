...
import { getAlwaysFreeArticle, getPreviousAlwaysFreeArticle, getNextAlwaysFreeArticle } from "@/libs/newt/always_free_article";
...
export default async function AlwaysFreeArticleDetailPage({
    ...
    const [prevArticle, nextArticle] = await Promise.all([
        getPreviousAlwaysFreeArticle(article as always_free_article),
        getNextAlwaysFreeArticle(article as always_free_article),
    ]);
