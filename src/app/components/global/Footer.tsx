...
const FooterText: React.FC = () => (
    <span className="font-light text-light-text dark:text-dark-text md:text-base">
...
const FooterLink: React.FC<FooterLinkProps> = ({ href, text, rel }) => (
    <Link
        href={href}
        rel={rel}
        className="mx-1 text-light-accent hover:text-light-hover dark:text-dark-accent dark:hover:text-dark-hover"
    >
        {text}
    </Link>
);
